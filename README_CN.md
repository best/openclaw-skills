...
| [feed-collect](./feed-collect/) | AI 信息流采集（Miniflux 本地配置 + HN + GitHub Trending） | v2.1.1 |
| [feed-broadcast](./feed-broadcast/) | AI 信息流智能播报（自主判断推送/跳过） | v1.1.2 |
| [feed-score](./feed-score/) | AI 信息流评分、去重、Markdown 生成与发布 | v2.1.7 |
