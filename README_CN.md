...
| [gemini-imagegen](./gemini-imagegen/) | Gemini 3.1 Flash Image (Nano Banana 2) 图片生成与编辑 | v0.2.0 |
| [discord-thread-archiver](./discord-thread-archiver/) | Discord Thread 智能归档（AI 对话分析） | v0.3.0 |
