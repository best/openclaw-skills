...
| [dream](./dream/) | AI Agent 的 REM 睡眠记忆整合 | v1.0.0 |
| [discord-thread-archiver](./discord-thread-archiver/) | Discord Thread 智能归档（AI 判定对话状态） | v1.0.0 |
| [evolution-engine](./evolution-engine/) | PCEC v4 — 数据驱动技能进化引擎 | v2.0.0 |
