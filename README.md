...
| [dream | Memory methodology & consolidation — 4-action model, 3 independent flows, dream diary (dated files in own folder), T0 grounded in injection mechanism + fact-review self-correction | v2.3.0 |
