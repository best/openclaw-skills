...
| [dream | Memory methodology & consolidation — 4-action model, 3 independent flows, dream diary (dated files in own folder), T0 grounded in injection mechanism + fact-review with structured verification | v2.4.0 |
...
| [openai-image-gen](./openai-image-gen/) | Image generation and editing with OpenAI Image API (default gpt-image-2) + provider fallback | v1.1.0 |
