...
| [feed-collect](./feed-collect/) | AI news feed collection via deterministic feedctl runner | v2.3.0 |
| [feed-broadcast](./feed-broadcast/) | AI Feed broadcast via controlled wrapper and delivery guards | v1.3.0 |
| [feed-score](./feed-score/) | AI Feed scoring via controlled runner and validated publish flow | v2.3.0 |
