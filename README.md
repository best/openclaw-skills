...
| [feed-broadcast](./feed-broadcast/) | AI news feed smart broadcast with push/skip judgment | v1.0.1 |
| [feed-score](./feed-score/) | AI news feed scoring, dedup, Markdown generation and publishing | v1.2.0 |
...
| [wechat-article-fetcher](./wechat-article-fetcher/) | Fetch and extract content from WeChat Official Account articles | v1.0.0 |
